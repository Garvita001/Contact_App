...
const Dashboard = () => {
  ...
  return (
    <div className="  w-full pt-20 px-4 pb-8">
      ...
      <div className="border-2 border-gray-200 w-11/12  m-auto 10 auto 10">
        {chartData.datasets ? (
          <Line data={chartData} />
        ) : (
      ...
      <h1 className="text-4xl font-bold mb-4 mt-4 text-gray-500">
        Corona Cases on World Map
      </h1>
      <div className="border-2 border-gray-500 w-11/12  m-auto 5 auto 5">
        <MapContainer
          className="m-auto w-full  border-gray-700"
          bounds={[
            [-60, -180],
            [85, 180],
          ]}
